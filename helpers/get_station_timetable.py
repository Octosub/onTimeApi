...
def get_station_timetable(station_name: str, direction: str):
    ...
    response = requests.get(f"https://api.odpt.org/api/v4/odpt:Station?dc:title={station_name}&acl:consumerKey=r3o6gvgluq1fazxove7cmodkkh8ko0w72j6m5yetkzzcynaiispwy1zxru160ccs")
    ...
    timetable_response = requests.get(f"https://api.odpt.org/api/v4/odpt:StationTimetable?odpt:station={station_id}&acl:consumerKey=r3o6gvgluq1fazxove7cmodkkh8ko0w72j6m5yetkzzcynaiispwy1zxru160ccs")
